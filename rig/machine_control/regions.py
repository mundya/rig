...
class RegionTree(object):
    ...
    list which of their sixteen chips are part of the region.
    ...
    def get_regions(self):
        ...
        if self.locally_selected != set():
            # Build up the code for this region
    ...
    def add_coordinate(self, x, y):
        ...
        if self.level == 3:
            ...
            if subregion in self.locally_selected:
                return self.locally_selected == set(range(16))
            ...
            # If the subregion is full then we mark it as selected on this
            # level.
            if self.subregions[subregion].add_coordinate(x, y):
                self.locally_selected.add(subregion)

                # Remove the subregion as we no longer need to hold a reference
                # to it.
                self.subregions.pop(subregion)
